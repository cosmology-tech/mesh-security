...
export declare type ExecuteMsg = VaultApiExecMsg | ExecMsg;
export declare type VaultApiExecMsg = {
    release_cross_stake: {
        amount: Coin;
        owner: string;
        [k: string]: unknown;
...
export declare type QueryMsg = VaultApiQueryMsg | QueryMsg1;
export declare type VaultApiQueryMsg = string;
...
export declare type MaybeAccountResponse = {
