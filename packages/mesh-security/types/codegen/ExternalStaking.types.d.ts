...
export declare type ExecuteMsg = CrossStakingApiExecMsg | ExecMsg;
export declare type CrossStakingApiExecMsg = {
...
export declare type QueryMsg = CrossStakingApiQueryMsg | QueryMsg1;
export declare type CrossStakingApiQueryMsg = {
    max_slash: {
        [k: string]: unknown;
    };
};
...
export declare type MaybePendingRewards = {
    rewards: Coin;
} | {
    locked: {};
};
...
export declare type IbcOrder = "ORDER_UNORDERED" | "ORDER_ORDERED";
...
export declare type PointsAlignment = Uint256;
